...
scan_pattern='(/Users/|Desktop/<local-screenshots>|截圖[[:space:]]+20|螢幕錄影|sunjiarong@|[A-Za-z0-9._%+-]+@(gmail|hotmail|outlook|yahoo)\.[A-Za-z]{2,}|sk-[A-Za-z0-9_-]{20,}|gh[pousr]_[A-Za-z0-9_]{20,}|AKIA[0-9A-Z]{16})'
